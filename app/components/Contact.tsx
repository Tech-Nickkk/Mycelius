...
export default function Contact() {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="relative flex flex-col items-center justify-center min-h-screen bg-[#ffffff] text-[#12110E] overflow-hidden pt-24 pb-72 md:pb-60 px-6 md:px-12"
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center text-center gap-10">
        {/* Heading */}
        <div ref={headingRef}>
          <h2 className="text-[6.5vw] md:text-[4.5vw] lg:text-[3.5vw] font-normal leading-[1.2] tracking-tight font-ppeditorial text-[#12110E]">
            <span
      ...
      <div className="absolute bottom-0 left-0 w-full p-6 md:p-10 z-20 text-white font-suisse select-text">
        <div className="max-w-6xl mx-auto flex flex-col gap-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            ...
            {/* Email & Web */}
            <div className="flex flex-col gap-1">
              <a href="mailto:bioshift@myceliuslab.com" className="text-sm font-light text-white/90 hover:text-[#FF6118] transition-colors duration-300">
                bioshift@myceliuslab.com
              </a>
              <a href="https://www.myceliuslab.com" target="_blank" rel="noopener noreferrer" className="text-sm font-light text-white/90 hover:text-[#FF6118] transition-colors duration-300">
                www.myceliuslab.com
              </a>
            </div>
          ...
          {/* Legal Info Row */}
          <div className="flex justify-between items-center border-t border-white/10 pt-4 text-xs font-light text-white/40">
