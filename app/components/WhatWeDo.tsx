      ...
      <div className="relative w-[90vw] md:w-[75vw] lg:w-[60vw] h-[55vh] md:h-[65vh] lg:h-[75vh]">
        ...
        >
          ...
          <div className="absolute max-md:hidden md:bottom-[4%] md:right-[-25%] xl:right-[-30%] overflow-hidden pointer-events-none z-30 grid">
            ...
            <h1 className="new-title-text title-1 col-start-1 row-start-1 justify-self-end whitespace-nowrap text-[60px] md:text-[80px] lg:text-[100px] max-sm:text-[40px] font-normal text-white leading-none font-ppeditorial tracking-tight px-[0.2em] py-[0.05em] text-right">
              {stories[activeStory].title[1]}
            </h1>
          </div>
        </div>
